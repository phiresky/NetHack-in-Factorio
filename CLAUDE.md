...
scripts/encyclopedia.lua    — Encyclopedia lookup table (generated by parse_encyclopedia.py, gitignored)
...
build/parse_encyclopedia.py — Parse data.base + tile names -> encyclopedia.lua lookup table
